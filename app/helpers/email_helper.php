...
<div class="wrapper">
	...
	<a href="mailto:{{EMAIL_SUPPORT}}" target="_blank">{{EMAIL_SUPPORT}}</a></p>
...
<div class="wrapper">
	...
	<h1>Link Aktivasi Akun</h1>
	<p>Hi {{NAME}}, Anda baru saja mendaftar di {{JUDUL_WEB}}. Untuk menyelesaikan proses pendaftaran, konfirmasi alamat email Anda dengan mengklik tombol berikut ini:</p>
	<p>
		<a class="button" href="{{url}}" target="_blank" >
...
<div class="wrapper">
	...
	<h1>Link Aktivasi Akun</h1>
	<p>Hi {{NAME}}, Anda baru saja mendaftar di {{JUDUL_WEB}}. Untuk mengaktifkan akun Anda, silahkan masukkan kode verifikasi berikut ini di halaman verifikasi:</p>
	<p>
		<a class="button" href="#" >
		<span>{{PIN}}</span></a>
	</p>
...
<div class="wrapper">
	...
	<p>
	Hi {{NAME}}, kami mengirim email ini karena kami mendapat permintaan reset password, silakan klik tombol berikut untuk membuat password baru:
	</p>
	<p>
		<a class="button" href="{{url}}" target="_blank" >
