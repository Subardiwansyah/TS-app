<div class="card">
	...
	<div class="card-body">
		...
		if (!$result) {
			...
			$settings['buttons'][] = [["extend" => 'pdfHtml5', "exportOptions" => ["modifier" => ["order" => "index","page" => "all","search" => "none"], 'columns'=> [ 0, 2, 3, 4, 5, 6, 7 ]]],["extend" => 'excelHtml5', "exportOptions" => ["modifier" => ["order" => "index","page" => "all","search" => "none"], 'columns'=> [ 0, 2, 3, 4, 5, 6, 7 ]]]];
