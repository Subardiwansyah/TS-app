		...
		<form method="post" action="" id="form-container" enctype="multipart/form-data">
			<div class="tab-content" id="myTabContent">
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input class="form-control" type="text" name="question" value="<?=set_value('question', @$question)?>" placeholder="Question" required="required"/>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<textarea class="form-control" type="text" name="answer" placeholder="Answer" required="required"><?=set_value('answer', @$answer)?></textarea>
					</div>
				</div>
				<div class="form-group row">
