		...
		<form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
			<div class="tab-content">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input class="form-control" type="text" disabled name="name" value="<?=set_value('name', @$name)?>" placeholder="Nama Produk" required="required"/>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Deskripsi</label>
					<div class="col-sm-8">
						<textarea class="form-control" name="description" disabled placeholder="Deskripsi" required="required"><?=set_value('description', @$description)?></textarea>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-8 form-inline">
						...
						//foreach ($status as $item) {
							...
							$isShowPrice['N'] = "No";
						//}
						echo options(['name' => 'show_price', 'disabled'=>'disabled','id'=> 'show_price'], $isShowPrice, set_value('show_price', @$show_price));?>
					</div>
				</div>
				<div class="form-group row" id="div_price">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Harga Asli</label>
					<div class="col-sm-5">
						<input class="form-control" type="text" name="price" disabled value="<?=set_value('price', @$price)?>" placeholder="Harga ASli" required="required"/>
					</div>
				</div>
				<div class="form-group row" id="div_promo">
					...
					<div class="col-sm-8 form-inline">
						...
						//foreach ($status as $item) {
							...
							$isPromo['N'] = "No";
						//}
						echo options(['name' => 'promo', 'disabled'=>'disabled','id'=> 'promo'], $isPromo, set_value('promo', @$promo));?>
					</div>
				</div>
				<div class="form-group row" id="div_price_promo">
					...
					<div class="col-sm-5">
						<input class="form-control" id="price_promo" type="text" name="price_promo" disabled value="<?=set_value('price_promo', @$price_promo)?>" placeholder="Harga Promo" required="required"/>
					</div>
				</div>
				<div class="form-group row">
