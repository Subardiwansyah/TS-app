			...
			<div class="tab-content">				
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						echo options(['name' => 'id_kategori', 'disabled'=>'disabled', 'id' => 'id_kategori', 'onchange'=>"selectProduk(this.options[this.selectedIndex].value)"], $options_kategori, set_value('id_kategori', @$id_kategori))?>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						echo options(['name' => 'id_subkategori', 'disabled'=>'disabled', 'id' => 'id_subkategori'], $options_subkategori, set_value('id_subkategori', @$id_subkategori))?>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Faulty code</label>
					<div class="col-sm-5">
						<input class="form-control" type="text" name="faulty_code" disabled value="<?=set_value('faulty_code', @$faulty_code)?>" placeholder="Faulty Code" required="required"/>
					</div>
				</div>
