		...
		<form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
			<div class="tab-content">				
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input class="form-control" type="text" name="nama_kategori" disabled value="<?=set_value('nama_kategori', @$nama_kategori)?>" placeholder="Nama Kategori" required="required"/>
					</div>
				</div>
