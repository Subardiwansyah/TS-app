			...
			<div class="tab-content">
				<div class="col-6">			
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input class="form-control" type="date" data-date="" data-date-format="DD MMMM YYYY" name="wty_start" <?=$disabled?> value="<?=set_value('wty_start', (@$wty_start))?>" placeholder="WTY Start" required="required"/>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3 col-form-label">WTY End</label>
						<div class="col-sm-5">
							<input class="form-control" type="date" data-date="" data-date-format="DD MMMM YYYY" name="wty_end" disabled value="<?=set_value('wty_end', (@$wty_end))?>" placeholder="WTY End"/>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row mb-0">
						<div class="col-sm-8">
							<button type="submit" name="submit" value="submit" <?=$disabled?> class="btn btn-primary">Submit</button>
