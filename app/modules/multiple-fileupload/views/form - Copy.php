									...
									if (file_exists($config['dokumen_path'] . $val_data)){
										echo '
											<div class="input-group mb-2">
												...
												<input readonly name="current_file" class="form-control text-muted" type="text" value="' . $judul_file[$key_data] . '"/>
												<a href="javascript:void(0)" class="input-group-append bg-danger input-group-text text-white remove-current-file">
													<i class="fa fa-times"></i>
												</a>
												<input type="hidden" name="delete_current_file_id_akta_file[]" value="'. $id_akta_file[$key_data].'"/>
												<input type="hidden" name="delete_current_file_nama_file[]" value="'. $nama_file[$key_data].'"/>
