			...
			?>
			 <form action="<?= base_url('listing/tambah'); ?>" method="POST" enctype="multipart/form-data">
				 ...
				 <div class="form-group mb-3">
					 ...
					 <select class="col-md-12 form-control" aria-label="Default select example" name="kategori" id="kategori">
				 ...
				 <div class="form-group mb-3">
					 ...
					 <select class="col-md-12 form-control" aria-label="Default select example" name="lokasi" id="lokasi">
				 ...
				 <div class="form-group mb-3">
					 ...
					 <select class="col-md-12 form-control" aria-label="Default select example" name="agent" id="agent">
				 ...
				 <div class="form-group mb-3">
					 ...
					 <select class="col-md-12 form-control" name="nego" id="nego">
				 ...
				 <div class="form-group mb-3">
					 ...
					 <select class="col-md-12 form-control" aria-label="Default select example" name="perabot" id="perabot">
				 ...
				 <div class="form-group mb-3">
					 ...
					 <select class="col-md-12 form-control" aria-label="Default select example" name="seterfikat" id="seterfikat">
				 ...
				 <div class="form-group mb-3">
					 ...
					 <select class="col-md-12 form-control" aria-label="Default select example" name="sell/rent" id="sell/rent">
				 ...
				 <div class="form-group mb-3">
					 ...
					 <select class="col-md-12 form-control" aria-label="Default select example" name="featured" id="featured">
						 <option value="Tidak">Tidak</option>
						 <option value="Ya">Ya</option>
					 </select>
				 </div>
				 ...
				 <div class="form-group mb-3">
					 ...
					 <select class="col-md-12 form-control" aria-label="Default select example" name="aktif" id="aktif">
						 <option value="Ya">Ya</option>
						 <option value="Tidak">Tidak</option>
					 </select>
				 </div>
		...
		<div class="tab-pane fade <?=$images_tab_content?>" id="gallery-produk" role="tabpanel" aria-labelledby="gallery-produk-tab">
			...
			if (empty($id_produk)) {
				...
				<form method="post" action="" class="form-container" enctype="multipart/form-data">
					...
					?>
					<div class="form-group row submit" style="display:none">
						<div class="col-sm-12">
