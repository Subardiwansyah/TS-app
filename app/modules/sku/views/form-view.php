			...
			<div class="tab-content">				
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						echo options(['name' => 'id_kategori', 'id' => 'id_kategori', 'onchange'=>"selectProduk(this.options[this.selectedIndex].value)", 'disabled'=>'disabled'], $options_kategori, set_value('id_kategori', @$id_kategori))?>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						echo options(['name' => 'id_subkategori', 'id' => 'id_subkategori', 'disabled'=>'disabled'], $options_subkategori, set_value('id_subkategori', @$id_subkategori))?>
					</div>
				</div>
				<!--
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						echo options(['name' => 'id_brand', 'disabled'=>'disabled'], $options_brand, set_value('id_brand', @$id_brand))?>
					</div>
				</div>
				-->
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						...
						<input class="form-control" disabled type="text" name="sku" value="<?=set_value('sku', @$sku)?>" placeholder="SKU Produk" required="required"/>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Deskripsi Produk</label>
					<div class="col-sm-5">
						<input class="form-control" type="text" name="nama_produk" value="<?=set_value('nama_produk', @$nama_produk)?>" placeholder="Nama Produk" disabled required="required"/>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Wty Period</label>
					<div class="col-sm-3">
						<input class="form-control" disabled type="text" name="wty_period" value="<?=set_value('wty_period', @$wty_period)?>" placeholder="Wty Period" required="required"/>
					</div>
				</div>
