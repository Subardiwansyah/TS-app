		...
		<form method="post" action="" id="form-container" enctype="multipart/form-data">
			<div class="tab-content" id="myTabContent">
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input class="form-control" type="text" name="nama_store" disabled value="<?=set_value('nama_store', @$nama_store)?>" placeholder="Nama Store" required="required"/>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<textarea class="form-control" type="text" name="alamat" disabled placeholder="Alamat" required="required"><?=set_value('alamat', @$alamat)?></textarea>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-5 form-inline">
						...
						echo options(['name' => 'aktif','disabled'=>'disabled'], $options, set_value('aktif', @$aktif));?>
					</div>
				</div>
				<?php 
				$id = '';
