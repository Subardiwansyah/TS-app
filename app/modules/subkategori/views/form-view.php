			...
			<div class="tab-content">
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						echo options(['name' => 'id_kategori', 'disabled'=>'disabled'], $options, set_value('id_kategori', @$id_kategori))?>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Produk</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="nama_subkategori" disabled value="<?=set_value('nama_subkategori', @$nama_subkategori)?>" placeholder="Nama Subkategori"/>
					</div>
				</div>
