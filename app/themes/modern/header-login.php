...
.background {
	<?php if($setting_web['background']!=""){?>
	background: url('<?php echo $config['base_url'] . 'public/images/' . $setting_web['background']?>?r=<?=time()?>');
	<?php }?>
...
<body>
	...
	<div class="login-container">
		<div class="login-header">
			<div class="logo">
				<a href="<?php echo $config['base_url']?>"><img src="<?php echo $config['base_url'] . 'public/images/' . $setting_web['logo_login']?>?r=<?=time()?>"></a>
			</div>			
			<?php if (!empty($desc)) {
				echo '<p>' . $desc . '</p>';
			}?>
