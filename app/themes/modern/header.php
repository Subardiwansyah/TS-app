...
<link rel="shortcut icon" href="<?=$config['base_url'] . 'public/images/'.$setting_web['favicon'].'?r=' . time()?>" />
...
<body>
	<header class="nav-header">
		<div class="nav-header-logo pull-left">
			<a class="header-logo" href="<?=$config['base_url']?>" title="<?php echo $setting_web['company']?>">
		...
		<div class="pull-right nav-header nav-header-right">
			...
			<ul>
				...
				<li>
					<?php $img_url = !empty($user['avatar']) && file_exists(BASE_PATH . '/uploads/profile/' . $user['avatar']) ? $config['base_url'] . $config['user_images_path'] . $user['avatar'] : $config['base_url'] . $config['user_images_path'] . 'no-user.jpg';
